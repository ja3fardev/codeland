...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",
      className
    )}
    {...props}
  />
